      ...
      <div className="container">
        <div className="header">
          ...
          <div className="header-subtitle">
            <h2>
              Tell me which topic you want to learn and I will give a brief
              description followed by few questions and answers for you to
              revise!
              <br></br>
        ...
        <div className="prompt-container">
          ...
          <div className="prompt-buttons">
            <a
              className="coffee"
              href="https://www.buymeacoffee.com/steve004"
              target="_blank"
            >
              <img
